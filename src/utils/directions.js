...
export const FetchDirections = (coords, directionsMode) =>
  new Promise((resolve, reject) => {
    ...
    const url = `https://api.mapbox.com/directions/v5/mapbox/${directionsMode}/${start[0]}%2C${start[1]}%3B${
      end[0]
    }%2C${end[1]}?alternatives=false&geometries=geojson&steps=false&access_token=${MAP_TOKEN}`;
    fetch(url)
